# Shared Visual Fables

Use this before `data-metaphors.md` when the source idea is abstract, the audience is broad, or the first concept needs explanation.

## Selection Ladder

Search in this order:

1. familiar everyday action
2. common proverb, idiom, or visual fable
3. professional analogy familiar to the audience
4. data-native object or invented symbol

Prefer the earliest option that preserves the exact claim.
...
- **Sledgehammer for a walnut**: a giant tool threatens to destroy the object it is meant to open.
  - Best for: excessive method complexity and collateral damage.

### Measurement vs. action

- **A thermometer cannot reduce fever**: the patient hugs the measuring instrument while medicine remains unused.
  - Best for: analysis without intervention, diagnosis without action.

- **A fire alarm without an extinguisher**: people applaud an accurate alarm while a small fire continues.
  - Best for: detection without response.

- **A map is not a journey**: someone frames a perfect map but never leaves the chair.
  - Best for: insight without execution.
...
- **Paint the target after the arrow lands**: someone shoots first, then paints a bullseye around the hit.
  - Best for: opinion before data, cherry-picking, post-hoc justification.

- **Sprinkle dots around a pre-drawn line**: a manager draws the trend first and adds observations afterward.
  - Best for: data forced to fit a preferred narrative.
...
- **Untangle one strand at a time**: a visible path emerges from a dense but finite tangle.
  - Best for: disciplined simplification.
...
- **Measure a flower but smell it too**: instruments capture shape, not fragrance.
  - Best for: dimensions that resist quantification.

## Semantic Fidelity Gate

For every candidate, write:

- **Exact claim**: what the source actually says.
- **Fable claim**: what the scene naturally says without a caption.
- **Added implication**: what the fable introduces.
- **Lost nuance**: what it leaves out.

Reject the fable if the added implication becomes the main lesson.

## Three-Second Test

All must be true:

- The viewer can name the literal action immediately.
- The mismatch is visible without a title.
- No abstract object needs a legend.
- The scene works in grayscale.
- One prop and one action carry most of the meaning.
- Removing another object would weaken, not improve, the joke.

## Audience Calibration

For Chinese general readers, prefer widely recognized Chinese idioms and universal daily experiences. Avoid a culture-specific reference unless the surrounding article supplies it.
